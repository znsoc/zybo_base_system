...
xv_path="/mnt/workspace/toolchains/2016.4/Vivado/2016.4"
...
{
  file="xsim.ini"
  lib_map_path="/mnt/workspace/toolchains/2016.4/Vivado/2016.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
