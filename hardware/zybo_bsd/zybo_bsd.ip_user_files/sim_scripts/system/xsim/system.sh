...
xv_path="/mnt/workspace/toolchains/2017.2/Vivado/2017.2"
...
{
  file="xsim.ini"
  lib_map_path="/mnt/workspace/toolchains/2017.2/Vivado/2017.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
