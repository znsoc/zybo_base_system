...
bfm_lib_dir="/mnt/workspace/toolchains/2016.4/Vivado/2016.4/lib/lnx64.o"
...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/ed72/hdl" \
       +incdir+"$ref_dir/../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"$ref_dir/../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/ed72/hdl" \
       +incdir+"../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
